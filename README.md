...
| `Line follower.ipynb` | Notebook used for experiments, analysis, or interactive demos. |
...
1. Clone the repository.
   ...
   ```bash
   git clone https://github.com/devMuniz02/Car-lane-detector.git
   cd Car-lane-detector
   ```
